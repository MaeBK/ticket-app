  ...
  static List<EventComponent> getEvents() {
    ...
    events.add(
      EventComponent(
        ...
        description:
            'Come join us in Vegas to compete in one of the '
    ...
    events.add(
      EventComponent(
        ...
        boxColor: Color(0xFFB39DDB),
        description:
            'Do you thing you have the chops to cook with some'
    ...
    events.add(
      EventComponent(
        ...
        boxColor: Color(0xFFB39DDB),
        description:
            "'TWRP is coming to a town near you, to spend their birthday with YOU!! "
    ...
    events.add(
      EventComponent(
        ...
        boxColor: Color(0xFFB39DDB),
        description:
            'The name says it all! Get your forks and spoons ready, '
    ...
    events.add(
      EventComponent(
        ...
        boxColor: Color(0xFFB39DDB),
        description:
            "Weather you're a coffee drinker or a coffee maker, "
